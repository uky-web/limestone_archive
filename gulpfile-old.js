...
gulp.task('styles', gulp.series(runIconfont, () => {
  var sassOptions = {
    // outputStyle: 'nested',
    eyeglass: {
...
gulp.task('build-all', gulp.series('styles', lib, js, xml, images, fonts, buildNpm));



// all the watchy stuff
gulp.task('watcher', gulp.series('build-all', () => {
